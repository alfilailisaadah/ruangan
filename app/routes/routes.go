...
func (cl *ControllerList) RouteRegister(e *echo.Echo) {
	...
	rooms.PUT("/update", cl.RoomsController.Update, middleware.JWTWithConfig(cl.JWTMiddleware))
	...
	rents.GET("/list", cl.RentsController.GetAll, middleware.JWTWithConfig(cl.JWTMiddleware))
	rents.PUT("/update", cl.RentsController.Update, middleware.JWTWithConfig(cl.JWTMiddleware))
}
